...
## [1.29.0](https://github.com/Raphael2001/career-ops/compare/career-ops-v1.28.0...career-ops-v1.29.0) (2026-09-09)


### Features

* **anti-fabrication:** tier the Source-of-Truth boundary and add story-provenance-check ([#2947](https://github.com/Raphael2001/career-ops/issues/2947)) ([498dd11](https://github.com/Raphael2001/career-ops/commit/498dd112eb6fa35333aa6c00cef3f8cbce6944d0))
* **deploy:** add stealth/ox-alpha as 3rd fallback, right after Cloudflare ([899f87f](https://github.com/Raphael2001/career-ops/commit/899f87f0a3e0187e48883a7e86c9fdf3ae763b21))
...
* **litellm:** add Cloudflare Workers AI provider ([167d610](https://github.com/Raphael2001/career-ops/commit/167d6104fd8b0c00a42d695dcc8dbaf5a6e2fd3f))
* **litellm:** add mistral-small-latest as 6th fallback ([b29181d](https://github.com/Raphael2001/career-ops/commit/b29181d80d2b122b4cc94fe5720a1cbdaacd68b9))
* **litellm:** load-balance across nvidia/stealth/cloudflare instead of pinning nvidia ([37cc828](https://github.com/Raphael2001/career-ops/commit/37cc8280a8814a4a0a6282f0142c3c972e18ef25))
* **litellm:** multi-provider rate-limit fallback chain ([fe12ae0](https://github.com/Raphael2001/career-ops/commit/fe12ae0c53782a5bef67bf11b22277a034b870c1))
* **litellm:** wire CEREBRAS_API_KEY/MISTRAL_API_KEY plumbing ([b193b24](https://github.com/Raphael2001/career-ops/commit/b193b24f6d32e160a6950bf9ae896428712e7b6e))
* **monitor:** add a manual scan-trigger button, fix stuck "Last started" ([77ab5f5](https://github.com/Raphael2001/career-ops/commit/77ab5f57351613c07792249b5d1f8215799ec955))
* **monitor:** add a Stop control for the discovery scan ([c3bd12e](https://github.com/Raphael2001/career-ops/commit/c3bd12e617f80ef4f894e6e39985229f0faff144))
* **monitor:** add a totals row to the Usage table ([96187c0](https://github.com/Raphael2001/career-ops/commit/96187c0e65a0f8dc8f9bffd9c37f7c1add0d0358))
* **monitor:** add standalone infra-monitoring dashboard ([8b822f9](https://github.com/Raphael2001/career-ops/commit/8b822f9ed84e1d3b4dfaf47d62d0abf05db4c8ae))
* **monitor:** improve Models tab ([59f5e4c](https://github.com/Raphael2001/career-ops/commit/59f5e4c9e9a3a29aacfd0df518881e87d0297d28))
* **monitor:** move into docker-compose, drop SSH entirely ([2688076](https://github.com/Raphael2001/career-ops/commit/268807671c2574bb98de52e182dcef191a8561b6))
* **monitor:** move model usage to its own dated tab ([704eb3a](https://github.com/Raphael2001/career-ops/commit/704eb3a824e8414e6f2a6af0c53aa5e52ca19630))
* **monitor:** show last scan start time on the Overview card ([842acea](https://github.com/Raphael2001/career-ops/commit/842acea9641679380f03036a087310218d17b2c8))
* **monitor:** switch to yarn, add light theme ([0401592](https://github.com/Raphael2001/career-ops/commit/04015927d6a767a6a4e12aac0332d75f14fd3c54))
* **pdf:** declare CV section order in config/profile.yml ([#2533](https://github.com/Raphael2001/career-ops/issues/2533)) ([c90b139](https://github.com/Raphael2001/career-ops/commit/c90b13975c7e0ff3c724744608652929678e88a0))
...
* **providers:** add jobbankca, Canada's federal Job Bank ([7e9feb4](https://github.com/Raphael2001/career-ops/commit/7e9feb4a43b26e0b63aea66425195b7f85062dbd))
* **scan:** add Hacker News scanner with optional AI enhancement ([f93b6e9](https://github.com/Raphael2001/career-ops/commit/f93b6e9b3baf4122475e1492850591c917951eda))
* **scan:** add reject_remote opt-out for the location-filter's remote-title rescue ([d70703f](https://github.com/Raphael2001/career-ops/commit/d70703f592d9fb4c4f28e77e00ecde478ffc12fb))
* **scan:** opt-in anchored keyword matching ([82be449](https://github.com/Raphael2001/career-ops/commit/82be44956a41dcc7c406073902dd2ddcdc0338c8))
* **verify-pipeline:** flag a malformed follow-ups.md instead of reading it as empty ([#2971](https://github.com/Raphael2001/career-ops/issues/2971)) ([a5ffae2](https://github.com/Raphael2001/career-ops/commit/a5ffae2accf300366df24cd9e853475f3d9bf22b))
...
* **add-entry:** delegate flag validation to shared validateFlags ([3507239](https://github.com/Raphael2001/career-ops/commit/3507239f8fb495025c5d0d7abdcd5b17f7e57490))
* **agent-inbox:** seed the queue under the lock, not before it ([e585853](https://github.com/Raphael2001/career-ops/commit/e585853f60db86abd9802a53e6f3c10862e038e6))
...
* **ashby:** stop retrying a permanent failure, and honour a clamped Retry-After ([#3072](https://github.com/Raphael2001/career-ops/issues/3072)) ([27fcd48](https://github.com/Raphael2001/career-ops/commit/27fcd48e60a3cf34edd97742e0656b2534c2b5af))
* **batch:** keep JD word count machine-readable under FORCE_COLOR ([bf9a6ae](https://github.com/Raphael2001/career-ops/commit/bf9a6aec0713cfe067bd913355637924114006dc))
* cleanup_browser() also needed &lt; /dev/null, real root cause of the 1-company-only bug ([5eab3c3](https://github.com/Raphael2001/career-ops/commit/5eab3c3bf12204be5499cec45ae3dab6b62fa291))
* **cli:** validate browser-extract flags and honour both value forms ([cfe50c3](https://github.com/Raphael2001/career-ops/commit/cfe50c3458377f60754d52f684f25fb8f1a650f4))
* **comeet:** actually fall back to url_comeet_hosted_page, not just pick-and-hope ([8f5a68e](https://github.com/Raphael2001/career-ops/commit/8f5a68e7531f75b421d57bbe5fecb06759cbce60))
* **cv:** honor Korean profile font theme ([70a062c](https://github.com/Raphael2001/career-ops/commit/70a062cbfc1abe810b747773778feada524315de))
* **dates:** seven more today-gates resolve in UTC ([2e4458e](https://github.com/Raphael2001/career-ops/commit/2e4458ed8e067fb8af53f167e2324e25ad284c74))
* **deploy:** call Cloudflare Workers AI direct, drop unconfigured AI Gateway header ([cabcdfc](https://github.com/Raphael2001/career-ops/commit/cabcdfcbf179e2a792ade5b9bb0725f88d10a799))
* **deploy:** cap container memory, auto-restart the Actions runner ([68ca1a8](https://github.com/Raphael2001/career-ops/commit/68ca1a85f9a5273d0a56b34228ca6236c05ced9a))
* **deploy:** claude-headless.sh -- --dangerously-skip-permissions refuses root, use --allowedTools instead ([973d5f9](https://github.com/Raphael2001/career-ops/commit/973d5f9c9444c8c044400d6a12769ded6592db68))
* **deploy:** claude-headless.sh -- pipe prompt via stdin, --allowedTools was swallowing it as a positional arg ([3bf2ed8](https://github.com/Raphael2001/career-ops/commit/3bf2ed8d8b8f289f612e6dd2ec81bab01ef004d5))
* **deploy:** container-start.sh npm-ci freshness check was always false on a fresh volume ([ccba2fe](https://github.com/Raphael2001/career-ops/commit/ccba2fef0fc8cfa64bc3828726afe43b5e395212))
* **deploy:** interpolate real title/location filters into discover's Level-1 prompt ([81b97d5](https://github.com/Raphael2001/career-ops/commit/81b97d50491d1875b382013f90c8cbe78023e339))
* **deploy:** isolate playwright-mcp browser profile, cleanup orphaned processes ([57dbb83](https://github.com/Raphael2001/career-ops/commit/57dbb836b41042016dc7a20098452c7a62502f8f))
* **deploy:** reorder Cloudflare to 2nd fallback, drop redundant NVIDIA model ([9578e24](https://github.com/Raphael2001/career-ops/commit/9578e2445dd15f767c05b8aef36c61f6fd978321))
* **deploy:** serve web UI in dev mode, next build crashes in container env ([92393eb](https://github.com/Raphael2001/career-ops/commit/92393ebb04415ab41dbc8745e15fc6959abdef81))
* **deploy:** split Level-1 scan into model-judges/script-writes ([5bc9e42](https://github.com/Raphael2001/career-ops/commit/5bc9e422ef6eeb18a6867eb256619c018646ace4))
* **deploy:** sync ZAI_API_KEY into host .env ([d05f112](https://github.com/Raphael2001/career-ops/commit/d05f1120cf0a75ae0b458364f2d687da2eb20cd9))
...
* **detect-reposts:** concurrent openings were reported as reposts ([18ff33d](https://github.com/Raphael2001/career-ops/commit/18ff33d92ad5e2a2b9a9af90b2018977fb845548))
* **docker:** install jq -- discover-companies-native.sh needs it, wasn't in the image ([378b0ec](https://github.com/Raphael2001/career-ops/commit/378b0ec2f4457356837abd3826616faa3c9fe67c))
* **docker:** run container as non-root pwuser ([9300d24](https://github.com/Raphael2001/career-ops/commit/9300d24eb4407dce633f3ac81b61ebb2233690cd))
* don't redirect stdin on the pipe-fed writer calls ([7e2caa8](https://github.com/Raphael2001/career-ops/commit/7e2caa81118614d31fac34fb230a482e9449d725))
* **litellm:** correct stale Groq/OpenRouter model ids, add Z.ai fallback ([08b25d6](https://github.com/Raphael2001/career-ops/commit/08b25d6742b87e2012cbadd8edddb2ff84ac0c88))
* **litellm:** correct zai-model id to glm-4.6 ([eb88530](https://github.com/Raphael2001/career-ops/commit/eb88530b4ad07557932907690f04ad8be907bab1))
* **litellm:** drop dead GitHub Models fallback ([e5efd60](https://github.com/Raphael2001/career-ops/commit/e5efd608743b134197631fc995dba020f6800e89))
* **litellm:** reduce career-ops/top3 to the healthy Groq member ([acb5cb6](https://github.com/Raphael2001/career-ops/commit/acb5cb692952cfd7a3f37cd368b9ad45a59e135b))
* **litellm:** route glm-4.7-flash through Z.ai's own free tier ([1970f79](https://github.com/Raphael2001/career-ops/commit/1970f7979f379bf05225f663381496296f2cd186))
* **litellm:** route zai-model through OpenRouter's free tier ([b0b0223](https://github.com/Raphael2001/career-ops/commit/b0b02231f16bcb7478eb9fec7b13cd154274c037))
* **litellm:** use Cloudflare only as fallback ([6c98846](https://github.com/Raphael2001/career-ops/commit/6c98846748034bf83ee8fe3ce24fb02b67340476))
* **liveness:** a dead third-party host must not poison the whole verdict ([1389e6c](https://github.com/Raphael2001/career-ops/commit/1389e6cb6186facf2fc847666d9ae85d2723d568))
* **locks:** share the waiting half of the protocol with the three lock copies ([39f87cd](https://github.com/Raphael2001/career-ops/commit/39f87cd7ad40825649ef930e2103911b88407f51))
* **monitor:** add loading state to /models -- was reading as broken ([69e15cb](https://github.com/Raphael2001/career-ops/commit/69e15cb4ff976ece4840297336ceda99f0f09f4c))
* **monitor:** cache Models-tab health for 5min, fix Dockerfile's accidental yarn dependency ([8fd5b89](https://github.com/Raphael2001/career-ops/commit/8fd5b89a857d9c298a53d4662b8808f9f978023b))
* **monitor:** dedupe concurrent getHealth() calls ([47fa361](https://github.com/Raphael2001/career-ops/commit/47fa361d0fb9f668f089997296bce5e481033e19))
* **monitor:** drop the "showing latest N of total" note on Usage ([dbb016c](https://github.com/Raphael2001/career-ops/commit/dbb016cef5db0f3670a10c58aee8c1e3f1cade78))
* **monitor:** equalize Overview card heights ([e2f88c2](https://github.com/Raphael2001/career-ops/commit/e2f88c2b2ef6bc7a24db5a26ff8d1ac0a81582b6))
* **monitor:** page through spend/logs/v2 past its 1000-row cap ([22e0e54](https://github.com/Raphael2001/career-ops/commit/22e0e54474ecce98ce55424536afc376df287e64))
* **monitor:** stop scan pkill was killing its own invocation ([9ea87de](https://github.com/Raphael2001/career-ops/commit/9ea87de744f7c64f64a66b1567fb5379f18d378b))
* **monitor:** stop-scan pkill was self-matching via its own alternation ([91725d2](https://github.com/Raphael2001/career-ops/commit/91725d2af6f84b5432452a25cae91e4a1e1600cf))
* **monitor:** switch spend-logs fetch to litellm's paginated v2 endpoint ([27047cd](https://github.com/Raphael2001/career-ops/commit/27047cd02eb4efce9362bbbb1132e09595bcd50e))
* **monitor:** unanchor the company-line grep/regex ([90a9a9c](https://github.com/Raphael2001/career-ops/commit/90a9a9c3816b562906ef47d38a908a2c3367a4dc))
* **pdf:** name canonicalization failure separately from a real workspace escape ([e4a21ba](https://github.com/Raphael2001/career-ops/commit/e4a21ba91c2dbbd96f01722b516a120cc7d56df2))
* **pipeline-lock:** a vanished lock is not a lock you may delete ([680419f](https://github.com/Raphael2001/career-ops/commit/680419f9d5316c0b8ec07f35fecfaa6c21b73e2b))
* **pipeline-lock:** carry the judged directory's identity to the rm ([7ada146](https://github.com/Raphael2001/career-ops/commit/7ada14663a2e91d9cd927120f9f6e23e14df141f))
* **plugins:** discover a plugin directory that is symlinked into a plugin root ([b9fe775](https://github.com/Raphael2001/career-ops/commit/b9fe7758af5e75b104be2c82d070e60f482f1dde))
* **portals.example:** name the support ROLE, not the whole domain ([d57a243](https://github.com/Raphael2001/career-ops/commit/d57a24371113ef41d5caaf15b58490c84d7a1a44))
* **portals:** correct stale Wiz/Snyk slugs, close empty-board blind spot ([fd67489](https://github.com/Raphael2001/career-ops/commit/fd6748961161bcb1156af6d13f6d510c3148a8cc))
* **portals:** Gong was pointed at an unrelated Polish recruitee board ([38436c9](https://github.com/Raphael2001/career-ops/commit/38436c969dab587ce963cdefa4718afc7cc4e533))
* **portals:** Pentera off dead pinpointhq subdomain, onto comeet ([366feac](https://github.com/Raphael2001/career-ops/commit/366feace5a3330d87b043580574ff8117d6186ff))
* **portals:** reapply Wiz/Snyk ATS fix, fall back DoControl off dead comeet ([f146281](https://github.com/Raphael2001/career-ops/commit/f146281c3da16a3bd74246437a3c254de5d04a89))
* **portals:** resolve 5 more boards from careers-page ATS detection ([e5694b4](https://github.com/Raphael2001/career-ops/commit/e5694b483964a14be952536fb0092a128cf8b46c))
* **portals:** resolve BlueVine to Greenhouse; disable 5 acquired/defunct boards ([7235570](https://github.com/Raphael2001/career-ops/commit/72355703669d8eafcd99fdc733abb911bb215068))
* **portals:** resolve Comeet API tokens + ATS slugs ([3fa0370](https://github.com/Raphael2001/career-ops/commit/3fa037016f7b18c533e2075f2b262f74c0510bac))
...
* **providers/lever:** fold categories.allLocations into location ([e3260d8](https://github.com/Raphael2001/career-ops/commit/e3260d8a4aeca5cae8d486d1f3dbd61a0a583a1f))
* **providers:** retire echojobs, feed is gone behind bot protection ([2c42733](https://github.com/Raphael2001/career-ops/commit/2c42733852db7cf6e779547e6b10df9bb7a3e7fc))
* **templates:** extend profile font_family override to ja and zh blocks ([5291cc7](https://github.com/Raphael2001/career-ops/commit/5291cc79755caf249a73313b949b6763ef16e260))
* **templates:** keep a project's tech line with the description above it ([676efcd](https://github.com/Raphael2001/career-ops/commit/676efcd32a26aa83d635098608851b0b2c986945))
* **tests:** assert flag echo by substring, not by unescaped RegExp ([6c2220f](https://github.com/Raphael2001/career-ops/commit/6c2220fc6114cba3df74e9f1cb743afe60fef833))
* **tests:** guard the web/ mirror import behind existsSync ([e09e3cd](https://github.com/Raphael2001/career-ops/commit/e09e3cd5cc98b42dd6040bfa7731b308cc4c6e8e))
* **tests:** keep the end of a failing script's output, not just the head ([#3035](https://github.com/Raphael2001/career-ops/issues/3035)) ([a0f4622](https://github.com/Raphael2001/career-ops/commit/a0f46223372a01730b74e16e7c0f89c26d1c41ea))
* **update:** refuse non-canonical paths in the local declaration file ([764f20f](https://github.com/Raphael2001/career-ops/commit/764f20f87df9a8c413b74d82626cc4c9c83209d6))
* **updater:** parse the SYSTEM_PATHS array instead of scraping it with a regex ([#3099](https://github.com/Raphael2001/career-ops/issues/3099)) ([61f8850](https://github.com/Raphael2001/career-ops/commit/61f8850d14e828567a3cc7f7a665e9e440c4eed0))
* **updater:** settle same-version SHA mismatch on tree content, not SHAs ([b00619d](https://github.com/Raphael2001/career-ops/commit/b00619d6b562879f44798e9fa70cf67ecd1a696f))
* **update:** stop misreading upstream's own content as a local edit ([#3094](https://github.com/Raphael2001/career-ops/issues/3094)) ([50c5400](https://github.com/Raphael2001/career-ops/commit/50c54008c078b339e4da4f4427b5a253e28c95a1))
* **verify-portals:** stop the slug repair path adopting a stranger's board ([d3b830d](https://github.com/Raphael2001/career-ops/commit/d3b830d18c46f727dd07158828e9e11a421f9183))
...
* **web:** allow configured trusted LAN dashboard host ([5be2b08](https://github.com/Raphael2001/career-ops/commit/5be2b0897bc503bf80747414d9c369236223de64))
