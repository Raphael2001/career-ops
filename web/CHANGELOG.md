...
## [0.8.0](https://github.com/Raphael2001/career-ops/compare/web-v0.7.1...web-v0.8.0) (2026-09-09)
...
* **pdf:** honor config cv.max_pages as a hard page cap on web renders ([8251469](https://github.com/Raphael2001/career-ops/commit/82514696eaa1706693977ee03c6d4e57fe662656))
...
* **portals:** scope the Fix-button reverify to one company, not all 164 ([db571b3](https://github.com/Raphael2001/career-ops/commit/db571b3603c18f6da09cc9afb9ae66a0a7c28b2f))
* **web,deploy:** shuffle discovery scans, restart on web/ source changes ([ffc48a3](https://github.com/Raphael2001/career-ops/commit/ffc48a371a06736e7088994547b6db119b54ff68))
...
* **web:** clear stale scan URL after Save as defaults; exclude C++ from portals.yml ([93777f8](https://github.com/Raphael2001/career-ops/commit/93777f8013ad53ae31680f297bf26f0ed071fd50))
* **web:** drop empty optional CV sections in the pdf tailoring prompt ([ab91bab](https://github.com/Raphael2001/career-ops/commit/ab91baba6f07746910e026084d8fb9e9d5a5f5e0))
* **web:** give AI search its own mode file instead of borrowing discover.md ([631ee17](https://github.com/Raphael2001/career-ops/commit/631ee1785546f726f4289b8fd3cdea5964689011))
* **web:** give evaluate the same 600s kill budget as fix-portal/pdf ([dbba538](https://github.com/Raphael2001/career-ops/commit/dbba538de11044160b86263fb050dda428a27570))
* **web:** give fix-portal the same 600s kill budget as pdf, not 285s ([8b7f80c](https://github.com/Raphael2001/career-ops/commit/8b7f80cce7af46fbf945c30d401d428a3dbced58))
...
* **web:** make AI-search location matching a hard filter, not a soft one ([983d9df](https://github.com/Raphael2001/career-ops/commit/983d9dff86658139d70541f374213c3dd1b50efe))
* **web:** pipeline inbox rows never linked to the actual posting ([faa52c8](https://github.com/Raphael2001/career-ops/commit/faa52c8cb73322860d448658a3b2709edfb0cd88))
* **web:** raise /api/run timeouts for the free-tier LiteLLM backend ([e23e05c](https://github.com/Raphael2001/career-ops/commit/e23e05c634e19993f5cf74867ad7c3ba1aaa63cb))
...
* **web:** strip WebFetch/WebSearch from fix-portal's tool scope ([9005a23](https://github.com/Raphael2001/career-ops/commit/9005a23ee7189d5c228d7800850b93e6ae40a97d))
